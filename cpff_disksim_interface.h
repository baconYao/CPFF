#ifndef CPFF_DISKSIM_INTERFACE_H
#define CPFF_DISKSIM_INTERFACE_H
...
#include "disksim_interface.h"								// include from disksim file
#include "disksim_global.h"									// include from disksim file

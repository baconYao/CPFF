...
all: disksim rms hplcomb syssim cpff
...
#the path of caching space policy, choose only one#
...
cpff: cpff_main.o libdisksim.a cpff_disksim_interface.o
	$(CC) $(CFLAGS) -o $@ cpff_main.o disksim_interface.o $(LDFLAGS) -pthread
